...
The purpose of this repository is to document my learning and practical experience in **Computer Networks, Network Security, VoIP systems, Firewalls, IDS/IPS, and Secure Remote Access**.
...
A network security lab built using **pfSense**, virtual machines, firewall rules, IDS/IPS monitoring, and controlled security testing.
